...
auto-trigger:
  - building any LLM-powered feature with Claude / Anthropic SDK
  - code references anthropic, claude, @anthropic-ai, claude-* model IDs
  - tool use, agents, MCP integration, streaming, token counting, batch API
  - choosing or migrating between Claude models
do-not-trigger:
  - OpenAI / GPT / Gemini / Llama / Mistral code (use their SDKs)
