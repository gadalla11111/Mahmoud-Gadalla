...
description: Face-swap YouTube thumbnails to feature Nick Saraev using AI. Use when user asks to recreate thumbnails, face swap images, generate YouTube thumbnails, or create thumbnail variations.
...
## Goal
Face-swap YouTube thumbnails to feature Nick Saraev using Gemini image model. The system analyzes face direction, matches reference photos by pose, and generates variations.
