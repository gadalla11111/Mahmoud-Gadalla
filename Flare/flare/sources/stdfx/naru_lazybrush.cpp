...
private:
  ...
  TPixelF maskColor;  // �}�X�N�̐F

  const float LoG_draw_scale = 20.f;   // LoG�t�B���^�̕`��X�P�[��
  float LoG_s                = 0.05f;  // LoG�t�B���^�̃X�P�[��
...
void naru_lazybrush::doGraph(TRasterPT<PIXEL> ras, double frame,
  ...
  int scribbleType = m_scrtype->getValue();  // �X�N���u���^�C�v 0:Soft, 1:Hard
